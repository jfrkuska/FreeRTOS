...
CFLAGS = -mcpu=cortex-a57 -ffreestanding -Wall -Wextra -g
#CFLAGS = -mcpu=cortex-a73 -ffreestanding -Wall -Wextra -g -DGUEST
...
#APP_SRC = ./FreeRTOS/Demo/CORTEX_A76_64-bit/
